-- Generate sequence numbers using Expression Transformation

CREATE TABLE gudiseva.dbo.SCNR_3_SRC (
...
INSERT INTO gudiseva.dbo.SCNR_3_SRC
...
SELECT * FROM gudiseva.dbo.SCNR_3_SRC;


CREATE TABLE gudiseva.dbo.SCNR_3_TGT (
...
SELECT * FROM gudiseva.dbo.SCNR_3_TGT;
